...
from xg_model import ascii_name, SHOT_TYPES, shot_xg, match_xg_map, is_shootout, player_xa_from_events
...
def _keeper_shot_extras(match_data, ex):
    ...
    partial (not every shot matches a FotMob one). Own goals are excluded entirely
    (not a shot faced by the opposing keeper at all)."""
